...
const WebManifestAssemblerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webmanifestassembler_free(ptr >>> 0, 1));
...
export class WebManifestAssembler {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WebManifestAssemblerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webmanifestassembler_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.webmanifestassembler_new();
        this.__wbg_ptr = ret >>> 0;
        WebManifestAssemblerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    push(frame) {
        ...
        const ret = wasm.webmanifestassembler_push(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
...
export class WebReceiver {
    ...
    snapshot_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webreceiver_snapshot_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @param {number} index
     */
    acknowledge_segment(index) {
        const ret = wasm.webreceiver_acknowledge_segment(this.__wbg_ptr, index);
        if (ret[1]) {
    ...
    constructor(manifest) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webreceiver_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WebReceiverFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {Uint8Array} frame
    ...
    ingest(frame) {
        const ptr0 = passArray8ToWasm0(frame, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webreceiver_ingest(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
export class WebSender {
     ...
     */
    manifest_frames() {
        const ret = wasm.websender_manifest_frames(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    constructor(input) {
        const ret = wasm.websender_new(input);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('qrbeam_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
